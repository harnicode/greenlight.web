...
//             {["about-us", "services", "team", "players", "contact-us"].map(
//               (section) => (
//                 <a
//                   key={section}
...
//       <div
//         className={`fixed inset-0 z-30 transition-opacity w-screen h-screen flex flex-col duration-300 bg-[gray]/40 backdrop-blur-lg p-3 md:p-6 md:px-[15rem] overflow-y-scroll ${
...
//                   >
//                     <div
//                       className="h-full bg-[white] -100 bg-opacity-3 backdrop-blur-sm rounded-md"
...
//                   <p className="text-md leading-[30px]">Full Legal Name</p>
//                   <p className="text-md leading-[30px]">Nationality</p>
//                   <p className="text-md leading-[30px]">Date of Birth</p>
//                   <p className="text-md leading-[30px]">Position</p>
//                   <p className="text-md leading-[30px]">Height</p>
//                   <p className="text-md leading-[30px]">Foot</p>
//                   <p className="text-md leading-[30px]">Language(s)</p>
//                 </div>
...
//                     {playerDetail?.height}
//                   </p>
//                   <p className="text-md text-right leading-[30px]">{playerDetail?.foot}</p>
//                   <p className="text-md text-right leading-[30px]">
...
//               <div className="flex md:flex-row gap-4 p-4 ps-0">
//                 <div className="flex-1 ps-4">
//                   <p className="text-md leading-[30px]">Professional Debut</p>
//                   <p className="text-md leading-[30px]">Current Club</p>
//                   <p className="text-md leading-[30px]">Contract End Date</p>
//                   <p className="text-md leading-[30px]">Transfer Fee</p>
//                   <p className="text-md leading-[30px]">
//                     International Competitions
//                   </p>
//                   <p className="text-md leading-[30px]">Awards</p>
//                 </div>
